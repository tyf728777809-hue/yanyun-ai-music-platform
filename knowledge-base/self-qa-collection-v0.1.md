...
当前已完成首批：寒香寻升级为剧情整合人物传；郑鄂、容鸢/慕容源、鬼市子完成实体边界修正；江无浪、褚清泉、红线、伊刀、天不收已新增高频人物卡。第二批已把寻心、千夜、阿依努尔/阿依奴、田英、叶万山、小十七、道主、无相皇扩到约 3 张创作卡；其中道主地下秩序仍标为 `pending_clues`，可进入写词 prompt，但只能作为暗线、传闻、情绪或意象使用。以下人物后续仍需要通过实录或更详细自问自答补到 3-5 张可靠卡：

- 寻心：继续补弱水岸实录、心魔/身份试炼台词、与寒香寻/洛神关系边界。
- 千夜：继续补绣金楼、夜行、旧怨、伪装和亲缘暗示的实录证据。
- 阿依努尔/阿依奴：继续补凉州、玉露为乡、身份与故乡、家族/地域情绪。
- 田英、叶万山、小十七：继续补对应任务线起承转合、人物关系和结局边界。
- 道主 / 无相皇：继续补势力核心、世界暗面、人物歌和反派歌角度；未核实内容保持 `pending_clues`，允许创作使用但不写成官方定论。
