...
| `public-real-full-experience` | public-network-full-experience | `succeeded_public_smoke` | 2026-06-11 combined DeepSeek + Yunwu Suno `chirp-fenix` + WellAPI Image 2 + local-process MP4 reached `GENERATED / PACKAGE_READY`; timestamped lyrics remains provider-path blocked. |
