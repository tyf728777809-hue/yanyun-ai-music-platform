...
| `public-real-full-experience` | public-network-full-experience | `succeeded_public_smoke` | 2026-06-14 knowledge-backed combined sample with DeepSeek + Yunwu Suno `chirp-fenix` + WellAPI Image 2 + `album-ffmpeg` reached `GENERATED / PACKAGE_READY`, then `PACKAGE_FETCHED`; Claude Web v1 handoff smoke fix verified against the same work. |
