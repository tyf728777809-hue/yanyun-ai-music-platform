...
- 人物：当前 `characters.json` 包含 60 条人物/人物群像/人物相关故事实体，其中 `character` 类型 59 个；覆盖寒香寻、寻心、阿依努尔、田英、叶万山、小十七、道主、无相皇、容鸢/慕容源、千夜、郑鄂、江无浪、褚清泉、红线、伊刀、天不收、玩家游侠、赵光义/晋中原、张彦霖、周蔷、魏仁浦、薛丑、洪肆、冯继昇、燕/应宁、蓬山四海豪客、四猫三鹅伙伴群像、姚药药、慧药、柴荣、王清、李祚、盈盈/温无缺、沈义伦、麻布袋、郭昕、张议潮、唐新词、画睛兄、兰澳、贺然、黎蓁蓁、柳青衣、柏楚玉、福禄寿三姐妹、赵大哥、龟奶奶、史鸩、石守信、慕容延钊等。
...
- 回归题库：164 条真实玩家输入样例，覆盖角色歌、剧情歌、地域歌、门派歌、普通玩家故事、玩法体验转译、其他 IP 拒绝、风格安全改写和待核线索谨慎使用。
