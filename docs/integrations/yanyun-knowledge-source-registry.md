...
- 人物：13 个实体，覆盖寒香寻、寻心、阿依努尔、田英、叶万山、小十七、道主、无相皇、慕容源、千夜、鬼市子、郑鄂、玩家游侠。
- 地域/场景：清河、开封、雁门、凉州、长安、青州、蓬山、神仙渡、弱水岸、不羡仙。
- 剧情/任务线：玉露为乡、弱水岸寻心、九流祸起、无名剑谱、开封夜市与鬼市、青州蓬山文津、清河初入江湖、门派倾覆、小人物不平事、同行伙伴。
...
- 回归题库：30 条真实玩家输入样例，覆盖角色歌、剧情歌、普通玩家故事、其他 IP 拒绝和风格安全改写。
