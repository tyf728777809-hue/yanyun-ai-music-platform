...
- 人物：当前 `characters.json` 包含 78 条人物/人物群像/人物相关故事实体，其中 `character` 类型 77 个；覆盖寒香寻、寻心、阿依努尔、田英、叶万山、小十七、道主、无相皇、容鸢/慕容源、千夜、郑鄂、江无浪、褚清泉、红线、伊刀、天不收、玩家游侠、赵光义/晋中原、张彦霖、周蔷、魏仁浦、薛丑、洪肆、冯继昇、燕/应宁、蓬山四海豪客、四猫三鹅伙伴群像、姚药药、慧药、柴荣、王清、李祚、盈盈/温无缺、沈义伦、麻布袋、郭昕、张议潮、唐新词、画睛兄、兰澳、贺然、黎蓁蓁、柳青衣、柏楚玉、福禄寿三姐妹、赵大哥、龟奶奶、史鸩、石守信、慕容延钊、朱鱼、冯夷、赵承宗、廉道子、张淮深、望月婵媛、安琉璃、鹰铃、宝音、方白、宋九薇、燕十七、小猫佑安、白狼主、花魁、叶墨城、福宝、时一墨等；P1 人物缺口已清空。
- 地域/场景：清河、开封、雁门、凉州、长安、青州、蓬山、神仙渡、弱水岸、不羡仙。
- 剧情/任务线：玉露为乡、弱水岸寻心、九流祸起、无名剑谱、开封夜市与鬼市、鬼市子/开封鬼市身份壳、青州蓬山文津、清河初入江湖、门派倾覆、小人物不平事、同行伙伴、清河主章·神仙不渡、不羡仙旧事、开封主章·天地熔炉、无忧洞、河西主章·问月长安。
...
- 回归题库：187 条真实玩家输入样例，覆盖角色歌、剧情歌、地域歌、门派歌、普通玩家故事、玩法体验转译、其他 IP 拒绝、风格安全改写和待核线索谨慎使用。

## Known Gaps

- P0-P4 已具备重型百科创作版基线，但 `commercial-final-gap-inventory.json` 仍列有待补人物、剧情、地域、势力、玩法和边界缺口；当前应按缺口表继续分批转入正式库。
