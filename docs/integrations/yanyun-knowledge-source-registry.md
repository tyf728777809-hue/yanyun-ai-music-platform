...
- 回归题库：176 条真实玩家输入样例，覆盖角色歌、剧情歌、地域歌、门派歌、普通玩家故事、玩法体验转译、其他 IP 拒绝、风格安全改写和待核线索谨慎使用。
