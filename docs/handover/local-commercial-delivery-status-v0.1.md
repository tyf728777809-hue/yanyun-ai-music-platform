...
2. 若要测真实 AI 出歌，先跑单作品 Yunwu Suno 公网受控 smoke；进入公司内网或生产联调时再切回 DreamMaker Suno / MiniMax。
3. 若要测真实写词，单独打开 DeepSeek 双开关跑一条样本，不同时打开真实音乐和真实 Image 2。
4. 若要测真实封面，先跑 WellAPI Image2 单作品受控 smoke；生产路径继续保留并验证 DreamMaker Image 2。
