...
- Outbox v0.1 与 Temporal v0.1 已落地并可本地验证；真实模型链路前的 activity 细化设计已补齐，后续实现时需把当前单一 activity 委托拆成更细粒度、可幂等重试的音乐生成、封面、视频、发布包等活动。
...
4. 按 `docs/specs/temporal-activity-decomposition-v0.1.md` 先实现 activity 接口和 Mock 测试骨架，再逐步拆音乐、封面、视频和发布包步骤。
