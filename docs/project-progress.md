...
4. 按 `docs/specs/temporal-activity-decomposition-v0.1.md` 继续推进分步 activity：下一步让分步 activity 逐步接入真实音乐、封面、视频和发布包状态推进；`stepwise-recording` 的 outbox + step audit 验收已可用专用脚本复验。
