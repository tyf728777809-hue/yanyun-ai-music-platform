...
7. 避免廉价古风堆词，不要过度使用“红尘、宿命、刀光剑影、天涯、此生无悔”等空泛表达。
8. 减少“明月、山河、江湖、风烟、长夜”等万能诗性词连续堆叠；禁止只靠“酒、剑、月、风”撑完整首歌。
9. 必须原创，不模仿、不改写、不借用现实歌曲歌词、影视台词或已有商业歌词。
10. 不写真实歌手名、现实歌曲名、翻唱导向、仿唱导向。
11. 只输出 JSON object，不输出 Markdown 或解释。
