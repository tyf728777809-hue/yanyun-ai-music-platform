...
12. 减少“明月、山河、江湖、风烟、长夜”等万能诗性词连续堆叠；禁止只靠“酒、剑、月、风”撑完整首歌。
13. 押韵要自然，不为了押韵牺牲内容，不使用生硬倒装、土味口号、网络梗或廉价古风词。
14. 必须原创，不模仿、不改写、不借用现实歌曲歌词、影视台词或已有商业歌词。
15. 不写真实歌手名、现实歌曲名、翻唱导向、仿唱导向。
16. 只输出 JSON object，不输出 Markdown 或解释。
